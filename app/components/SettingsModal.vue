...
const emit = defineEmits<{
  close: []
  'update:cantPlaceEffects': [effects: CantPlaceEffects]
}>()

// Theme settings
const { themePreference, setPreference, isDecember } = useTheme()

// Local copy of effects for editing
const localEffects = ref<CantPlaceEffects>({ ...props.cantPlaceEffects })

// Sync local effects when props change
watch(() => props.cantPlaceEffects, (newVal) => {
  localEffects.value = { ...newVal }
}, { deep: true })

// Emit changes when local effects change
watch(localEffects, (newVal) => {
  emit('update:cantPlaceEffects', { ...newVal })
}, { deep: true })
          ...
          <div class="modal-body">
            ...
            <section class="settings-section">
              ...
              <div class="effects-grid">
                <label class="effect-card" :class="{ active: localEffects.dimmedCells }">
                  <input type="checkbox" v-model="localEffects.dimmedCells" />
                ...
                <label class="effect-card" :class="{ active: localEffects.stripedPattern }">
                  <input type="checkbox" v-model="localEffects.stripedPattern" />
                  <span class="effect-icon">▧</span>
                  <div class="effect-info">
                ...
                <label class="effect-card" :class="{ active: localEffects.warningIcon }">
                  <input type="checkbox" v-model="localEffects.warningIcon" />
